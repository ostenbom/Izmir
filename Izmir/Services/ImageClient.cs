	...
	public class ImageClient
	{
		public async Task<List<Flickr>> GetImages ()
		{
			...
			using (var httpImageClient = CreateImageClient ()) {
				try {
					var imageresponse = await httpImageClient.GetAsync ("services/rest/?method=flickr.people.getPublicPhotos&api_key=05c1f8f86d099482489854588a178464&user_id=131444764%40N03&extras=url_q%2C+url_l&format=json&nojsoncallback=1&per_page=20").ConfigureAwait(false);
		...
		private const string FlickrBaseAddress = "https://api.flickr.com/";
